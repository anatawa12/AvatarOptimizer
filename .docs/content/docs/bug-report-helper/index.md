...
If you have configured any settings to work around a bug (such as disabling Features in Trace and Optimize), please disable those workaround settings before generating the bug report.\
