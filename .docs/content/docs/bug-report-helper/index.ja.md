...
### 他のバグレポート時にあると助かる情報 {#additional-helpful-information}

Bug Report Helper ではアバターの情報はわかるようになってますが、どのような不具合があったかという情報を集めることは難しいです。
そのため、正常な動作と Avatar Optimizer を入れた状態でどのように意図しない動作になるかを動画やスクリーンショットを使用して説明していただけると調査の助けになります。
