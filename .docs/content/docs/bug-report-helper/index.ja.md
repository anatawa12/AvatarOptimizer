...
### バグレポート時にあると助かる追加情報 {#additional-helpful-information}

Bug Report Helperではアバターの情報はわかるようになっていますが、どのような不具合があったかという情報を集めることは難しいです。
そのため、正常な動作と Avatar Optimizer を有効にした状態でどのように意図しない動作になるかを、動画やスクリーンショットを使用して説明していただけると調査の助けになります。
