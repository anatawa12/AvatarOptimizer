...
### バグ報告時にあると助かる追加の情報 {#additional-helpful-information}

Bug Report Helperでは、アバターの情報はわかるようになっていますが、どのような不具合があるかという情報を集めることは困難です。\
そのため、正常な状態での動作と、Avatar Optimizerを使用することで発生する意図しない動作のそれぞれについて、動画やスクリーンショットを用いて説明していただけると、調査の助けになります。
