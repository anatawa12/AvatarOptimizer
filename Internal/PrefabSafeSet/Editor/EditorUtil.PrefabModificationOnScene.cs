...
namespace Anatawa12.AvatarOptimizer.PrefabSafeSet
{
    ...
    {
        private sealed class PrefabModificationOnScene : EditorUtil<T>
        {
            ...
            private readonly SerializedProperty _usingOnSceneLayer;
                ...
                setValue)
            {
                ...
                _usingOnSceneLayer = property.FindPropertyRelative(Names.UsingOnSceneLayer);
                _onSceneLayer = property.FindPropertyRelative(Names.OnSceneLayer);
                _currentRemoves = _onSceneLayer.FindPropertyRelative(Names.Removes);
                _currentAdditions = _onSceneLayer.FindPropertyRelative(Names.Additions);
            ...
            private void Normalize()
            {
                ...
                else if (_prefabLayers.arraySize == _nestCount)
                {
                    ...
                    _prefabLayers.arraySize = _nestCount - 1;
                }
                else
                {
            ...
            private void ClearNonLayerModifications(SerializedProperty property, int nestCount)
            {
                try
                {
                    ...
                    var usingOnSceneLayerProp = $"{property.propertyPath}.{Names.UsingOnSceneLayer}";
                    var onSceneLayerProp = $"{property.propertyPath}.{Names.OnSceneLayer}";
                    ...
                    foreach (var modification in PrefabUtility.GetPropertyModifications(obj))
                    {
                        ...
                        // if property is usingOnSceneLayer: do nothing
                        if (modification.propertyPath.StartsWith(usingOnSceneLayerProp, StringComparison.Ordinal))
                            continue;
                        // if property is onSceneLayer: do nothing
                        if (modification.propertyPath.StartsWith(onSceneLayerProp, StringComparison.Ordinal)) continue;
            ...
            private class ElementImpl : IElement<T>
            {
                ...
                private readonly PrefabModificationOnScene _container;
                ...
                private ElementImpl(PrefabModificationOnScene container, int indexInModifier, T value, ElementStatus status,
                ...
                public static ElementImpl Natural(PrefabModificationOnScene container, T value, int nestCount) =>
                    new ElementImpl(container, -1, value, ElementStatus.Natural, nestCount, null);

                public static ElementImpl NewElement(PrefabModificationOnScene container, T value, int i)
                {
                ...
                public static ElementImpl FakeRemoved(PrefabModificationOnScene container, T value, int i)
                {
                ...
                public static ElementImpl NewSlot(PrefabModificationOnScene container, T value) =>
