    ...
    public class AnimatorTest
    {
        ...
        public void TestLayer08_Animate8To100WithSimpleDirectional2DBlendTree() =>
            LayerTest(8, "Animate8To100WithSimpleDirectional2DBlendTree",
                "blendShape.shape8", AnimationFloatProperty.ConstAlways(100, Source));
        ...
        public void TestLayer09_Animate9To100WithFreedomDirection2DBlendTree() =>
            LayerTest(9, "Animate9To100WithFreedomDirection2DBlendTree",
                "blendShape.shape9", AnimationFloatProperty.ConstAlways(100, Source));
        ...
        public void TestLayer10_Animate10To100WithFreeformCartesian2DBlendTree() =>
            LayerTest(10, "Animate10To100WithFreeformCartesian2DBlendTree",
                "blendShape.shape10", AnimationFloatProperty.ConstAlways(100, Source));

        [Test]
        public void TestLayer11_Animate11To100Partially() =>
            LayerTest(11, "Animate11To100Partially",
                "blendShape.shape11", AnimationFloatProperty.ConstPartially(100, Source));

        [Test]
        public void TestLayer12_AnimateOverride1To100() =>
            LayerTest(12, "AnimateOverride1To100",
                "blendShape.shape1", AnimationFloatProperty.ConstAlways(100, Source));

        [Test]
        public void TestLayer13_Animate12ToConst10() =>
            LayerTest(13, "Animate12ToConst10",
                "blendShape.shape12", AnimationFloatProperty.ConstAlways(10, Source));
        ...
        public void TestParseWhole()
        {
            ...
            Assert.That(properties["blendShape.shape0"], Is.EqualTo(AnimationFloatProperty.ConstAlways(100, Source)));
            Assert.That(properties["blendShape.shape1"], Is.EqualTo(AnimationFloatProperty.ConstAlways(100, Source)));
            Assert.That(properties["blendShape.shape2"], Is.EqualTo(AnimationFloatProperty.Variable(Source)));
            Assert.That(properties["blendShape.shape3"], Is.EqualTo(AnimationFloatProperty.Variable(Source)));
            Assert.That(properties["blendShape.shape4"], Is.EqualTo(AnimationFloatProperty.ConstAlways(100, Source)));
            Assert.That(properties["blendShape.shape5"], Is.EqualTo(AnimationFloatProperty.Variable(Source)));
            Assert.That(properties["blendShape.shape6"], Is.EqualTo(AnimationFloatProperty.Variable(Source)));
            Assert.That(properties["blendShape.shape7"], Is.EqualTo(AnimationFloatProperty.ConstAlways(100, Source)));
            Assert.That(properties["blendShape.shape8"], Is.EqualTo(AnimationFloatProperty.ConstAlways(100, Source)));
            Assert.That(properties["blendShape.shape9"], Is.EqualTo(AnimationFloatProperty.ConstAlways(100, Source)));
            Assert.That(properties["blendShape.shape10"], Is.EqualTo(AnimationFloatProperty.ConstAlways(100, Source)));
            Assert.That(properties["blendShape.shape11"], Is.EqualTo(AnimationFloatProperty.ConstPartially(100, Source)));
            Assert.That(properties["blendShape.shape12"], Is.EqualTo(AnimationFloatProperty.ConstAlways(10, Source)));
            Assert.That(properties["blendShape.shape13"], Is.EqualTo(AnimationFloatProperty.ConstAlways(10, Source)));
            //Assert.That(properties["blendShape.shape14"], Is.EqualTo(AnimationProperty.ConstAlways(, null)));
            Assert.That(properties["blendShape.shape15"], Is.EqualTo(AnimationFloatProperty.Variable(Source)));
        ...
        public void TestParseWholeWithExternalWeightChanges()
        {
            ...
            Assert.That(properties["blendShape.shape7"], Is.EqualTo(AnimationFloatProperty.ConstPartially(100, Source)));
            Assert.That(properties["blendShape.shape8"], Is.EqualTo(AnimationFloatProperty.ConstPartially(100, Source)));
            Assert.That(properties["blendShape.shape9"], Is.EqualTo(AnimationFloatProperty.Variable(Source)));
            Assert.That(properties["blendShape.shape10"], Is.EqualTo(AnimationFloatProperty.ConstAlways(100, Source)));
            ...
            Assert.That(properties["blendShape.shape16"], Is.EqualTo(AnimationFloatProperty.ConstPartially(100, Source)));
            //Assert.That(properties["blendShape.shape17"], Is.EqualTo(AnimationProperty.ConstAlways(100, null)));
        }
