    ...
    public class AnimatorTest
    {
        ...
        public void TestLayer08_Animate8To100WithSimpleDirectional2DBlendTree() =>
            LayerTest(8, "Animate8To100WithSimpleDirectional2DBlendTree",
                "blendShape.shape8", AnimationProperty.ConstAlways(100, null));
        ...
        public void TestLayer09_Animate9To100WithFreedomDirection2DBlendTree() =>
            LayerTest(9, "Animate9To100WithFreedomDirection2DBlendTree",
                "blendShape.shape9", AnimationProperty.ConstAlways(100, null));
        ...
        public void TestParseWhole()
        {
            ...
            Assert.That(properties["blendShape.shape0"], Is.EqualTo(AnimationProperty.ConstAlways(100, null)));
            ...
            Assert.That(properties["blendShape.shape3"], Is.EqualTo(AnimationProperty.Variable(null)));
            ...
            Assert.That(properties["blendShape.shape7"], Is.EqualTo(AnimationProperty.ConstAlways(100, null)));
            Assert.That(properties["blendShape.shape8"], Is.EqualTo(AnimationProperty.ConstAlways(100, null)));
            Assert.That(properties["blendShape.shape9"], Is.EqualTo(AnimationProperty.ConstAlways(100, null)));
            Assert.That(properties["blendShape.shape10"], Is.EqualTo(AnimationProperty.ConstAlways(100, null)));
            Assert.That(properties["blendShape.shape11"], Is.EqualTo(AnimationProperty.ConstPartially(100, null)));
        ...
        public void TestParseWholeWithExternalWeightChanges()
        {
            ...
            //Assert.That(properties["blendShape.shape5"], Is.EqualTo(AnimationProperty.Variable(null)));
            //Assert.That(properties["blendShape.shape6"], Is.EqualTo(AnimationProperty.Variable(null)));
            Assert.That(properties["blendShape.shape7"], Is.EqualTo(AnimationProperty.ConstPartially(100, null)));
            Assert.That(properties["blendShape.shape8"], Is.EqualTo(AnimationProperty.ConstPartially(100, null)));
            Assert.That(properties["blendShape.shape9"], Is.EqualTo(AnimationProperty.Variable(null)));
            Assert.That(properties["blendShape.shape10"], Is.EqualTo(AnimationProperty.ConstAlways(100, null)));
            ...
            ////Assert.That(properties["blendShape.shape14"], Is.EqualTo(AnimationProperty.ConstAlways(, null)));
            //Assert.That(properties["blendShape.shape15"], Is.EqualTo(AnimationProperty.Variable(null)));
            Assert.That(properties["blendShape.shape16"], Is.EqualTo(AnimationProperty.ConstPartially(100, null)));
            //Assert.That(properties["blendShape.shape17"], Is.EqualTo(AnimationProperty.ConstAlways(100, null)));
        }
            ...
            public MockedAnimationParser(GameObject prefab)
            {
                ...
                foreach (var (animName, property, constantValue) in AnimationTest.ConstSourceAnimations())
                {
                    ...
                    mods.ModifyObject(skinnedRenderer)
                        .AddModificationAsNewLayer(property, AnimationProperty.ConstAlways(constantValue, null));
                ...
                foreach (var (animName, property) in AnimationTest.VariableSourceAnimations())
                {
                    ...
                    var mods = new ModificationsContainer();
                    mods.ModifyObject(skinnedRenderer)
                        .AddModificationAsNewLayer(property, AnimationProperty.Variable(null));
                    _clips[clip] = mods.ToImmutable();
                }
            }
