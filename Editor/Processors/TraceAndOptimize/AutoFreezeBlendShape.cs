...
#if AAO_VRM0
            var vrmBlendShapeProxy = context.AvatarRootTransform.GetComponent<VRM.VRMBlendShapeProxy>();
            if (vrmBlendShapeProxy)
            {
                ...
                foreach (var binding in bindings)
                {
                    ...
                    set.Add(blendShapePropName);
                }
            }
#endif

#if AAO_VRM1
            var vrm10Instance = context.AvatarRootTransform.GetComponent<UniVRM10.Vrm10Instance>(); 
            if (vrm10Instance)
            {
