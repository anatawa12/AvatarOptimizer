...
namespace Anatawa12.AvatarOptimizer
{
    ...
    internal abstract class MergePhysBoneEditorModificationUtils
    {
        ...
        public MergePhysBoneEditorModificationUtils(SerializedObject serializedObject)
        {
            ...
            _mergedPhysBone = new SerializedObject(serializedObject.FindProperty("merged").objectReferenceValue);
            _makeParent = serializedObject.FindProperty(nameof(MergePhysBone.makeParent));
            _version = serializedObject.FindProperty(nameof(MergePhysBone.version));
            _integrationTypeProp = serializedObject.FindProperty(nameof(MergePhysBone.integrationType));
            _pullProp = serializedObject.FindProperty(nameof(MergePhysBone.pull));
            _springProp = serializedObject.FindProperty(nameof(MergePhysBone.spring));
            _stiffnessProp = serializedObject.FindProperty(nameof(MergePhysBone.stiffness));
            _gravityProp = serializedObject.FindProperty(nameof(MergePhysBone.gravity));
            _gravityFalloffProp = serializedObject.FindProperty(nameof(MergePhysBone.gravityFalloff));
            _immobileTypeProp = serializedObject.FindProperty(nameof(MergePhysBone.immobileType));
            _immobileProp = serializedObject.FindProperty(nameof(MergePhysBone.immobile));
            _limitsProp = serializedObject.FindProperty(nameof(MergePhysBone.limits));
            _maxAngleXProp = serializedObject.FindProperty(nameof(MergePhysBone.maxAngleX));
            _limitRotationProp = serializedObject.FindProperty(nameof(MergePhysBone.limitRotation));
            _maxAngleZProp = serializedObject.FindProperty(nameof(MergePhysBone.maxAngleZ));
            _radiusProp = serializedObject.FindProperty(nameof(MergePhysBone.radius));
            _allowCollisionProp = serializedObject.FindProperty(nameof(MergePhysBone.allowCollision));
            _collidersProp = serializedObject.FindProperty(nameof(MergePhysBone.colliders));
            _allowGrabbingProp = serializedObject.FindProperty(nameof(MergePhysBone.allowGrabbing));
            _grabMovementProp = serializedObject.FindProperty(nameof(MergePhysBone.grabMovement));
            _allowPosingProp = serializedObject.FindProperty(nameof(MergePhysBone.allowPosing));
            _stretchMotion = serializedObject.FindProperty(nameof(MergePhysBone.stretchMotion));
            _maxStretchProp = serializedObject.FindProperty(nameof(MergePhysBone.maxStretch));
            _maxSquish = serializedObject.FindProperty(nameof(MergePhysBone.maxSquish));
            _snapToHandProp = serializedObject.FindProperty(nameof(MergePhysBone.snapToHand));
            _isAnimatedProp = serializedObject.FindProperty(nameof(MergePhysBone.isAnimated));
            _resetWhenDisabledProp = serializedObject.FindProperty(nameof(MergePhysBone.resetWhenDisabled));
